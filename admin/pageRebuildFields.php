	...
	*/
	...
	$schema = array(
		'patients' => array(
			...
			'last_name' => array('appgini' => 'VARCHAR(40) not null '),
			'first_name' => array('appgini' => 'VARCHAR(40) not null '),
			'gender' => array('appgini' => 'VARCHAR(10) not null default \'Unknown\' '),
			'sexual_orientation' => array('appgini' => 'TEXT not null '),
			'birth_date' => array('appgini' => 'DATE not null '),
			'age' => array('appgini' => 'INT null '),
			'image' => array('appgini' => 'VARCHAR(40) null '),
			'address' => array('appgini' => 'TEXT null '),
			'city' => array('appgini' => 'VARCHAR(40) null '),
			'state' => array('appgini' => 'VARCHAR(15) null '),
			'zip' => array('appgini' => 'CHAR(8) null '),
			'home_phone' => array('appgini' => 'VARCHAR(40) null '),
			'work_phone' => array('appgini' => 'VARCHAR(40) null '),
			'mobile' => array('appgini' => 'VARCHAR(40) null '),
			'tobacco_usage' => array('appgini' => 'VARCHAR(40) not null default \'Unknown\' '),
			'alcohol_intake' => array('appgini' => 'VARCHAR(40) not null default \'Unknown\' '),
			'history' => array('appgini' => 'VARCHAR(100) not null default \'Unknown\' '),
			'surgical_history' => array('appgini' => 'TEXT null '),
			'obstetric_history' => array('appgini' => 'TEXT null '),
			'genetic_diseases' => array('appgini' => 'TEXT null '),
			'contact_person' => array('appgini' => 'VARCHAR(100) null '),
			'other_details' => array('appgini' => 'TEXT null '),
			'comments' => array('appgini' => 'TEXT null '),
			'filed' => array('appgini' => 'DATETIME null '),
			'last_modified' => array('appgini' => 'DATETIME null '),
		),
		'disease_symptoms' => array(
			'id' => array('appgini' => 'INT unsigned not null primary key auto_increment '),
			'disease' => array('appgini' => 'VARCHAR(200) not null unique '),
			'symptoms' => array('appgini' => 'TEXT not null '),
		...
		'events' => array(
			...
			'name_patient' => array('appgini' => 'INT unsigned null '),
			'time' => array('appgini' => 'TIME not null default \'12:00\' '),
			'prescription' => array('appgini' => 'VARCHAR(40) null '),
			'diagnosis' => array('appgini' => 'VARCHAR(40) null '),
			'comments' => array('appgini' => 'TEXT null '),
		),
		'medical_img' => array(
			'id' => array('appgini' => 'INT unsigned not null primary key auto_increment '),
			'patient' => array('appgini' => 'INT unsigned null '),
			'image' => array('appgini' => 'VARCHAR(40) not null '),
			'description' => array('appgini' => 'TEXT null '),
		),
		'medical_docs' => array(
			'id' => array('appgini' => 'INT unsigned not null primary key auto_increment '),
			'patient' => array('appgini' => 'INT unsigned null '),
			'doc' => array('appgini' => 'VARCHAR(40) not null '),
			'description' => array('appgini' => 'TEXT null '),
		),
	);
