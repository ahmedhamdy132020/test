...
// Download AppGini for free from https://bigprof.com/appgini/download/
	...
	$x->QueryFieldsTV = array(
		...
		"`medical_records`.`image`" => "image",
		"`medical_records`.`document`" => "document",
	...
	$x->ColCaption = array("Patient", "Image", "Document", "Description");
	$x->ColFieldName = array('patient', 'image', 'document', 'description');
